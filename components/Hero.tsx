    ...
    <section ref={sctionRef} id="hero" className="min-h-screen">
      ...
      <div className="">
        <Image
          ...
          alt="reactjs"
          className="absolute md:top-[100px] md:left-[230px] lg:top-[100px] lg:left-[430px]   animate-updown"
        />
        <Image
          width={75}
          height={75}
          ...
          alt="redux"
          className="absolute md:top-[170px] md:left-[150px] lg:top-[200px] lg:left-[300px] animate-updown"
        />
        <Image
          width={65}
          height={65}
          ...
          alt="typescript"
          className="absolute md:top-[100px] md:left-[60px] lg:top-[130px] lg:left-[140px] animate-updown"
        />
        <Image
          width={75}
          height={75}
          ...
          alt="tailwindcss"
          className="absolute md:top-[310px] md:left-[20px] lg:top-[300px] lg:left-[80px] animate-updown"
        />
        ...
        <Image
          ...
          alt="sass"
          className="absolute md:top-[170px] md:left-[420px] lg:top-[200px] lg:left-[800px] animate-updown"
        />
        <Image
          width={75}
          height={75}
          ...
          alt="html5"
          className="absolute md:top-[80px] md:left-[500px] lg:top-[250px] lg:left-[1000px] animate-updown"
        />
        <Image
          width={75}
          height={75}
          ...
          alt="css3"
          className="absolute md:top-[120px] md:left-[630px] lg:top-[120px] lg:left-[930px] animate-updown"
        />
        <Image
          width={100}
          height={100}
          ...
          alt="nodejs"
          className="absolute md:top-[420px] md:left-[450px] lg:top-[400px] lg:left-[950px] animate-updown"
        />
        <Image
          width={50}
          height={50}
          ...
          alt="javascript"
          className="absolute md:top-[330px] md:left-[550px] lg:top-[500px] lg:left-[850px] animate-updown"
        />
        ...
        <Image
          ...
          alt="graphql"
          className="absolute md:top-[310px] md:left-[320px]  lg:top-[450px] lg:left-[300px]  animate-updown"
        />
        <Image
          width={150}
          height={150}
          ...
          alt="jest"
          className="absolute md:top-[350px] md:left-[630px] lg:top-[450px] lg:left-[1000px] animate-updown"
        />
        ...
        <Image
          ...
          alt="kubernetes"
          className="absolute md:top-[420px] md:left-[200px] lg:top-[400px] lg:left-[160px] animate-updown"
        />
        ...
        <Image
          ...
          alt="docker"
          className="absolute  md:top-[500px] md:left-[100px]  lg:top-[570px] lg:left-[200px]  animate-updown"
        />
        <Image
          width={75}
          height={75}
          ...
          alt="aws"
          className="absolute md:top-[500px] md:left-[630px] lg:top-[570px] lg:left-[950px] animate-updown"
        />
        <Image
          width={60}
          height={60}
          ...
          alt="scrum"
          className="absolute  md:top-[400px] md:left-[45px] lg:top-[500px] lg:left-[75px] animate-updown"
        />
      </div>
