  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full md:w-1/2 lg:w-[40%]  ">
        <div className="absolute top-[20%] left-[25%] opacity-20 z-10 scale-150">
          <svg
            x="0px"
            y="0px"
            viewBox="0 0 288 288"
        ...
        <div className="grid grid-cols-5 grid-rows-3  p-5">
          ...
          <div className="row-start-2 col-start-4 col-span-2 z-20">
            <Image
              height={180}
              width={180}
