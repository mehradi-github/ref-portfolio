    ...
    <section ref={sctionRef} id="about" className=" bg-indigo-600 text-white">
      ...
      <div className="container mx-auto">
        <div className="  flex flex-col md:flex-row  items-center justify-center">
          <div className="relative w-full h-full md:w-[30%] lg:w-[40%]  ">
          ...
          <div className="w-full p-5  pb-10 md:pb-5 md:w-[70%] lg:w-[60%] flex flex-col flex-wrap justify-center items-start mx-5 py-5">
