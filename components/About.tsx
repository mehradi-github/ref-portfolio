      ...
      >
        <div className="container mx-auto">
          <div className="  flex flex-col md:flex-row  items-center justify-center">
            <div
              data-effect={effect}
              className="relative w-full h-full md:w-[30%] lg:w-[40%]  data-[effect=active]:animate-[slideInLeft_1200ms_ease-in-out_1]"
            >
            ...
            <div
              data-effect={effect}
              className="data-[effect=active]:animate-[slideInRight_1200ms_ease-in-out_1] w-full p-5  pb-10 md:pb-5 md:w-[70%] lg:w-[60%] flex flex-col flex-wrap justify-center items-start mx-5 py-5"
            >
              <div className="text-2xl font-bold py-5"> About Me</div>
              <div className="text-left ">
                A Software Engineer and senior Frontend developer with 8+ years
                of professional software programming, proficiency in developing
                ...
                needs and technology. A strong foundation in computer science
                and a wide range of experience in agile software development.
              </div>
              <div>
